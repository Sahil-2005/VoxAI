      ...
      <main className="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400 text-base">Sign in to your account to continue</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-xs font-semibold text-white hover:underline transition-colors">
                    Forgot password?
                  </Link>
                </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-3 bg-zinc-900/70 border border-zinc-800 rounded-xl text-zinc-300 text-sm font-semibold hover:bg-zinc-800 hover:text-white hover:border-zinc-700 transition-all hover:scale-[1.02] active:scale-95">
